        ...
        <div class="row">
          <div class="col s6">
            <a class="icon">
              <a
                v-if="!isCamera"
                @mousedown="focusColor('camera')"
                @touchstart="focusColor('camera')"
              >
              ...
              <a
                ...
                @mouseup="reader"
                @touchend="reader"
                @mouseover="basicColor('camera')"
                @touchmove="basicColor('camera')"
              >
          ...
          <div class="col s6">
            <a class="icon">
              <a
                v-if="!isBell"
                @mousedown="focusColor('bell')"
                @touchstart="focusColor('bell')"
              >
                <a
                  v-if="isNotification"
                  class="blinking"
              ...
              <a
                ...
                @touchend="notification"
                @mouseover="basicColor('bell')"
                @touchmove="basicColor('bell')"
              >
                <a
                  v-if="isNotification"
                  class="blinking"
